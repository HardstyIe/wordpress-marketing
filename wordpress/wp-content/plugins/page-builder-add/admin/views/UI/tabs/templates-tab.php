            ...
            <div class="pluginops-tab2-content">
              <div id="landingpages" class="pluginops-tab2 active">
                ...
                <div id="column-1" class="col">
                  ...
                  <div id="card" class="temp-prev-77 card template-card">
                          ...
                          <label for="temp-77" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b> </label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>

                  <div id="card" class="temp-prev-68 card template-card">
                          ...
                          <label for="temp-68" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>

                  <div id="card" class="temp-prev-62 card template-card">
                          ...
                          <label for="temp-62" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-34 card template-card">
                      ...
                      <label for="temp-34" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Click Through</span>
                  </div>

                  <div id="card" class="temp-prev-65 card template-card">
                          ...
                          <label for="temp-65" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-93 card tempPaca template-card">
                          ...
                          <label for="temp-93" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-92 card tempPaca template-card">
                          ...
                          <label for="temp-92" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-91 card tempPaca template-card">
                          ...
                          <label for="temp-91" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-90 card tempPaca template-card">
                          ...
                          <label for="temp-90" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation , Real Estate</span>
                  </div>

                  <div id="card" class="temp-prev-94 card tempPaca template-card">
                          ...
                          <label for="temp-94" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-89 card tempPaca template-card">
                          ...
                          <label for="temp-89" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-88 card tempPaca template-card">
                          ...
                          <label for="temp-88" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-85 card tempPaca template-card">
                          ...
                          <label for="temp-85" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-84 card tempPaca template-card">
                          ...
                          <label for="temp-84" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-83 card tempPaca template-card">
                          ...
                          <label for="temp-83" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-78 card tempPaca template-card">
                          ...
                          <label for="temp-78" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-82 card tempPaca template-card">
                          ...
                          <label for="temp-82" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-86 card tempPaca template-card">
                          ...
                          <label for="temp-86" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-80 card tempPaca template-card">
                          ...
                          <label for="temp-80" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-87 card tempPaca template-card">
                          ...
                          <label for="temp-87" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-66 card tempPaca template-card">
                          ...
                          <label for="temp-66" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-64 card tempPaca template-card">
                          ...
                          <label for="temp-64" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-42 card tempPaca template-card">
                          ...
                          <label for="temp-42" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  ...
                  <div id="card" class="temp-prev-41 card tempPaca template-card">
                          ...
                          <label for="temp-41" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  ...
                  <div id="card" class="temp-prev-40 card tempPaca template-card">
                          ...
                          <label for="temp-40" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Coming Soon</span>
                          <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-76 card tempPaca template-card">
                          ...
                          <label for="temp-76" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-81 card tempPaca template-card">
                          ...
                          <label for="temp-81" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-75 card tempPaca template-card">
                          ...
                          <label for="temp-75" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-79 card tempPaca template-card">
                          ...
                          <label for="temp-79" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-63 card tempPaca template-card">
                          ...
                          <label for="temp-63" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-61 card tempPaca template-card">
                          ...
                          <label for="temp-61" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-60 card tempPaca template-card">
                          ...
                          <label for="temp-60" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-59 card tempPaca template-card">
                          ...
                          <label for="temp-59" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-58 card tempPaca template-card">
                          ...
                          <label for="temp-58" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-55 card tempPaca template-card">
                          ...
                          <label for="temp-55" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Click Through</span>
                          <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-53 card tempPaca template-card">
                          ...
                          <label for="temp-53" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Click Through</span>
                          <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-54 card tempPaca template-card">
                          ...
                          <label for="temp-54" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Click Through</span>
                          <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-51 card tempPaca template-card">
                          ...
                          <label for="temp-51" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Click Through</span>
                          <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-50 card tempPaca template-card">
                          ...
                          <label for="temp-50" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-49 card tempPaca template-card">
                          ...
                          <label for="temp-49" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-48 card tempPaca template-card">
                          ...
                          <label for="temp-48" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-67 card tempPaca template-card">
                          ...
                          <label for="temp-67" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-38 card tempPaca template-card">
                          ...
                          <label for="temp-38" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Home Page</span>
                          <span class="temp-cats-displayed">Sales</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  ...
                  <div id="card" class="temp-prev-39 card tempPaca template-card">
                          ...
                          <label for="temp-39" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-35 card tempPaca template-card">
                          ...
                          <label for="temp-35" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Sales</span>
                          <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-36 card tempPaca template-card">
                          ...
                          <label for="temp-36" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Lead Generation</span>
                          <span class="temp-cats-displayed">Sales</span>
                  ...
                  <div id="card" class="temp-prev-37 card tempPaca template-card">
                          ...
                          <label for="temp-37" class="temp_selectLabel tempPaca">Pro Only</label>
                          <span class="temp-cats-displayed">Thank You</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-31 card tempPaca template-card">
                    <div id="temp-prev-31" class="tempPrev tempPaca"> <p id="temp-prev-31"><b>Preview</b></p></div>
                      ...
                      <label for="temp-31" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-32 card tempPaca template-card">
                      ...
                      <label for="temp-32" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Home Page</span>
                      <span class="temp-cats-displayed">Sales</span>
                      <span class="temp-cats-displayed">Click Through</span>
                  ...
                  <div id="card" class="temp-prev-109 card tempPaca template-card">
                      ...
                      <label for="temp-109" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-108 card tempPaca template-card">
                      ...
                      <label for="temp-108" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-107 card tempPaca template-card">
                      ...
                      <label for="temp-107" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Click Through</span>
                      <span class="temp-cats-displayed">Sales</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-69 card tempPaca template-card">
                      ...
                      <label for="temp-69" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-72 card tempPaca template-card">
                      ...
                      <label for="temp-72" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-74 card tempPaca template-card">
                      ...
                      <label for="temp-74" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-73 card tempPaca template-card">
                      ...
                      <label for="temp-73" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>

                  <div id="card" class="temp-prev-70 card template-card">
                      ...
                      <label for="temp-70" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                      <span class="temp-cats-displayed">Click Through</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-71 card tempPaca template-card">
                      ...
                      <label for="temp-71" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-105 card tempPaca template-card">
                      ...
                      <label for="temp-105" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Click Through</span>
                      <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-52 card tempPaca template-card">
                    ...
                    <label for="temp-52" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-33 card tempPaca template-card">
                      ...
                      <label for="temp-33" class="temp_selectLabel tempPaca">Pro Only</label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Thank You</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-30 card tempPaca template-card">
                    ...
                    <label for="temp-30" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Sales</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-29 card tempPaca template-card">
                    ...
                    <label for="temp-29" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                    <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-28 card tempPaca template-card">
                    ...
                    <label for="temp-28" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                    <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-27 card tempPaca template-card">
                    ...
                    <label for="temp-27" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Sales</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-24 card tempPaca template-card">
                    ...
                    <label for="temp-24" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Sales</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-25 card tempPaca template-card">
                    ...
                    <label for="temp-25" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                    <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-26 card tempPaca template-card">
                    ...
                    <label for="temp-26" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-10 card tempPaca template-card">
                    ...
                    <label for="temp-10" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-11 card tempPaca template-card">
                    ...
                    <label for="temp-11" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-13 card tempPaca template-card">
                    ...
                    <label for="temp-13" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                  ...
                  <div id="card" class="temp-prev-57 card tempPaca template-card">
                    ...
                    <label for="temp-57" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-56 card tempPaca template-card">
                    ...
                    <label for="temp-56" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-18 card tempPaca template-card">
                    ...
                    <label for="temp-18" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-19 card tempPaca template-card">
                    ...
                    <label for="temp-19" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-20 card tempPaca template-card">
                    ...
                    <label for="temp-20" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                    <span class="temp-cats-displayed">Click Through</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-22 card tempPaca template-card">
                    ...
                    <label for="temp-22" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                    <span class="temp-cats-displayed">Sales</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-23 card tempPaca template-card">
                    ...
                    <label for="temp-23" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-1 card tempPaca template-card">
                    ...
                    <label for="temp-1" class="temp_selectLabel tempPaca">Pro Only</label>
                  ...
                  <div id="card" class="temp-prev-5 card tempPaca template-card">
                    ...
                    <label for="temp-5" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-6 card tempPaca template-card">
                    ...
                    <label for="temp-6" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-7 card tempPaca template-card">
                    ...
                    <label for="temp-7" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Sales</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-8 card tempPaca template-card">
                    ...
                    <label for="temp-8" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-12 card tempPaca template-card">
                    ...
                    <label for="temp-12" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Click Through</span>
                    <span class="temp-cats-displayed">Lead Generation</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-14 card tempPaca template-card">
                    ...
                    <label for="temp-14" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-15 card tempPaca template-card">
                    ...
                    <label for="temp-15" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Thank You</span>
                  </div>
                  ...
                  <div id="card" class="temp-prev-21 card tempPaca template-card">
                    ...
                    <label for="temp-21" class="temp_selectLabel tempPaca">Pro Only</label>
                    <span class="temp-cats-displayed">Home Page</span>
                  </div>

                  <div id="card" class="temp-prev-106 card template-card">
                      ...
                      <label for="temp-106" class="temp_selectLabel" >Select <b style="color: #4CAF50;">Free</b></label>
                      <span class="temp-cats-displayed">Lead Generation</span>
                      <span class="temp-cats-displayed">Coming Soon</span>
                  </div>
